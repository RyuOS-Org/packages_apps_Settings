 ...
 * Copyright (C) 2025 Ryu-UI Project
 *
...
@SearchIndexable
public class DeviceDetailsFragment extends DashboardFragment {

    private static final String LOG_TAG = "DeviceDetailsFragment";
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.my_device_info_device_details;
    }
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
            Context context, DeviceDetailsFragment fragment, Lifecycle lifecycle) {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.my_device_info_device_details) {
