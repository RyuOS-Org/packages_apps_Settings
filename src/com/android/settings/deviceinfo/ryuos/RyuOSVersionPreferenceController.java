...
public class RyuOSVersionPreferenceController extends BasePreferenceController {

    private static final String TAG = "RyuOSVersionDialogCtrl";
    ...
    public RyuOSVersionPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_RYUOS_VERSION_PROP,
